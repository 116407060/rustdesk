...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("KMCRDP".to_owned());
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "715413".to_string());
        RwLock::new(map)};
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rdp.kmctr.com"];
pub const PUBLIC_RS_PUB_KEY: &str = "nP4owQMEuer9pp4oYeaTBgzvddhv2HScE2NkiHtRtN0=";
